"""Initial migration with SA user

Revision ID: 20250711_234404
Revises: 
Create Date: 2025-07-11 23:44:04.000000
...
def upgrade():
    ...
    with op.batch_alter_table('labs', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_labs_nickname'), ['nickname'], unique=True)
